        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    bitMask = table.Column<int>(nullable: false),
                    ...
                    bool3 = table.Column<bool>(nullable: false),
                    int1 = table.Column<int>(nullable: false),
                    int2 = table.Column<int>(nullable: false),
                    int3 = table.Column<int>(nullable: false),
                    longtext1 = table.Column<string>(nullable: true),
                    longtext2 = table.Column<string>(nullable: true),
                    longtext3 = table.Column<string>(nullable: true),
